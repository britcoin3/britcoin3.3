...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_StatisticsPage_t, stringdata) + ofs \
...
const QMetaObject StatisticsPage::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StatisticsPage.data,
      qt_meta_data_StatisticsPage,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_StatisticsPage.stringdata))
