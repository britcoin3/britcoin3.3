...
namespace Checkpoints
{
    ...
    // britcoin: synchronized checkpoint (centrally broadcasted)
    ...
    // britcoin: get last synchronized checkpoint
    ...
    // britcoin: only descendant of current sync-checkpoint is allowed
    ...
    // britcoin: reset synchronized checkpoint to last hardened checkpoint
...
// britcoin: verify signature of sync-checkpoint message
...
// britcoin: process synchronized checkpoint
